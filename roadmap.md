...
- [ ] Re-import into fresh Lovable project (code copied, Cloud enabled, schema applied) — verify pages load
- [ ] Wire brainstorm analysis into the chat so analysed text appears there automatically
